...
class ForecastDataMapper {
    fun convertFromDataModel(forecast: ForecastResult):ForecastList{
        return ForecastList(forecast.city.name, forecast.city.country, convertForecskListToDomain(forecast.list))
    }

    fun convertForecskListToDomain(forecastList: List<Forecast>): List<ModelForecast>{
